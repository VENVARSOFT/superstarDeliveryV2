...
const DropOrderScreen: React.FC<Props> = ({navigation, route}) => {
  ...
  const sendLocationUpdate = useCallback(
    (
      ...
      position: any,
      orderStatus: 'ASSIGNED' | 'IN_TRANSIT' | 'REACHED' | 'PICKED' | 'DELIVERED' = 'IN_TRANSIT',
    ) => {
  ...
  const handleOrderDelivered = useCallback(async () => {
    ...
    try {
      ...
      console.error('❌ Error getting current location for DELIVERED status:', error);
            ...
            <View style={styles.orderTotal}>
              ...
              <View style={[styles.totalRow, styles.finalTotal]}>
                ...
                <Text style={styles.finalTotalValue}>
                  ₹{(orderDetails.totalAmount || 0) + (orderDetails.deliveryFee || 0)}
                </Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.card}>
            <View style={styles.customerInfo}>
              ...
              <View style={styles.customerDetails}>
                ...
                <Text style={styles.customerPhone}>{orderDetails.customerPhone}</Text>
              </View>
              <TouchableOpacity
